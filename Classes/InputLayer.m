...
-(void) addFireButton
{
	...
	skinFireButton.position = CGPointMake(screenSize.width - buttonRadius * 1.0f, buttonRadius * 1.0f);
...
-(void) addJoystick
{
	...
	skinStick.position = CGPointMake(stickRadius * 1.0f, stickRadius * 1.0f);
